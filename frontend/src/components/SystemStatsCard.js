      ...
      <CardContent>
        ...
        {stats ? (
          <Grid container spacing={2} sx={{ mt: 1 }}>
            <Grid item xs={4}><Typography>CPU</Typography><Typography><b>{stats.cpu}%</b></Typography></Grid>
            <Grid item xs={4}><Typography>Memory</Typography><Typography><b>{stats.memory}%</b></Typography></Grid>
